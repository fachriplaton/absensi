    ...
    return DataTables::of($data)
      ...
      ->addColumn('action', function ($data) {
        ...
        <a href="' .
          ...
          '" class="btn btn-secondary btn-sm" data-id="' .
          $data['id'] .
          '" role="button"><i class="bx bxs-user"></i> <span style="margin-left:5px" class="badge bg-success">' .
          $data['pesertas_count'] .
          '</span></a>' .
          '<a href="' .
          route('ScanPeserta', ['id' => $data['id']]) .
          '" class="btn btn-success btn-sm" role="button"><i class="bx bx-scan"></i></a>' .
